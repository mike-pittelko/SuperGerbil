...
#define AXIS_N_SETTINGS          5 // was 3 Paul 15/08/2018
...
typedef struct {
  ...
  uint16_t dir_invert_mask; // Paul, adjusted
 ...
 // uint8_t flags;  // Contains default boolean settings
  ...
  uint8_t m6_ff; // added eeprom value for the tool changer pulse time
  uint32_t tool_delay; // added eeprom value for the tool changer pulse time
  uint32_t m6_delay; // added eeprom value for the tool valve duration time
